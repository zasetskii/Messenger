...
class TCPClient : public QObject
{
    ...
    Q_PROPERTY(VariantMapIdTableModel* messageModel READ getMessageModel NOTIFY messageModelChanged)
    Q_PROPERTY(QStringListModel* usersModel READ getUsersModel NOTIFY usersModelChanged)
    Q_PROPERTY(FriendsTableModel* friendsModel READ getFriendsModel NOTIFY friendsModelChanged)
...
private:
    VariantMapIdTableModel* getMessageModel() const;
    QStringListModel* getUsersModel() const;
    FriendsTableModel* getFriendsModel() const;
